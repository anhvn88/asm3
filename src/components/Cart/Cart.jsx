...
const Cart = () => {
  ...
  //   dispatch(counterActions.increment(productArray[0]._id.$oid));
  // };
  // const decrementHandler = () => {
  //   dispatch(counterActions.decrement(productArray[0]._id.$oid));
  // };
                  ...
                  return (
                    <>
                      <tr>
                        ...
                        <th className="cartName">{product[0].name}</th>
                        ...
                        <th className="cartQuantity">
                          <div className="plusMinus">
                            ...
                            <div className="countCart">{count}</div>
